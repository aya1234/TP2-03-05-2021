 ...
 */
final class Version20210503155515 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_95C71D1457108F2A ON cars');
        $this->addSql('ALTER TABLE cars DROP id_agence_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cars ADD id_agence_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cars ADD CONSTRAINT FK_95C71D1457108F2A FOREIGN KEY (id_agence_id) REFERENCES agence (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_95C71D1457108F2A ON cars (id_agence_id)');
    }
}
